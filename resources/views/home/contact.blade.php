    ...
    <div class="breadcumbs">
        <div class="container">
            <div class="d-flex justify-content-space-between align-items-center text-black">
                ...
                <div class="abouttxt active">Contact</div>
            </div>
        </div>
        <!-- end breadcumbs -->
        ...
        <div class="contact mt-3 mb-5">
            <div class="maps">
                <iframe src="https://www.google.com/maps/embed?pb={{ $contact->maps_embed }}" width="100%"
                    ...
                    <div class="col-md-12">
                        <div class="card border-4 porto-rad">
                            <div class="card-body px-4">
                                ...
                                <div class="row mt-4">
                                    <button type="submit" class="btn btn-submit porto-rad">Send Message</button>
                                </div>
                            </div>
                        </div>
                    </div>
