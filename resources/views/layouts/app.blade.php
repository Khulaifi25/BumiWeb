    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-primary">
            ...
            <a href="/admin/dashboard" class="brand-link">
                <img src="/lte/dist/img/logo.png" alt="AdminLTE Logo" class="brand-image img-circle"
                    style="opacity: .8">
                <span class="brand-text font-weight-bolder">BUMIADMIN</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="/lte/dist/img/admin.png" class="img-circle" alt="User Image">
                    </div>
                    <div class="info">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{ date('Y') }} <a href="https://bumiweb.site">BUMIWEB Team</a>.</strong> All
            rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
